...
class OpenRouterModel(BaseLlm):
    ...
    async def generate_content_async(
        ...
        # Start a manual span for OpenRouter generation
        # This ensures we have a span to link the prompt to, and also provides visibility into OpenRouter calls
        with tracer.start_as_current_span("OpenRouter.generate_content") as span:
